...
let AzureService = class AzureService {
    ...
    async getAzureConfigValue(keyId) {
        try {
            const client = new app_configuration_1.default.AppConfigurationClient('Endpoint=https://sasandboxappconfig.azconfig.io;Id=GpYT-l9-s0:WZExNWbjYLAxe2ep1XW3;Secret=EsUOGJm+GTGtGYHKBQD1zGGA4XBZz/jy5EZe5ibkCVE=');
